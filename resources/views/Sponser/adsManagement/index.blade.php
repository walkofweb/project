            ...
            <div class="carManagement__wrapper">
                <div class="breadcrumbWrapper d-flex align-items-center justify-content-between">
                    <nav aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                           <li class="breadcrumb-item"><a href="{{URL::to('/')}}/sponser/sdashboard#index" onclick="dashboard()" >Home</a></li>
    ...
    <div class="modal-dialog modal-dialog-slideout add_motification_modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-4">
                    <a href="javascript:void(0);"  onclick="submitNotifyFor1()" class="search-btn">Submit</a>
      ...
      columnDefs: [  
                ...
                },
                {
                    ...
                    "mRender": function(data, type, full){
                        ...
                        return '<th scope="row"><a href="'+baseUrl+'/sdashboard#advertisement_detail/'+full['id']+'" onclick="advertisementDetail('+full['id']+')"><i class="bi bi-chevron-right"></i></a></th> ';
                    }
                },
                {
                    "aTargets": [12],
