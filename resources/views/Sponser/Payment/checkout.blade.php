...
<head>
    ...
    <link rel="shortcut icon" href="{{URL::to('/public')}}/assets/images/favicon-32x32.png" type="image/png">
    ...
    <!--====== Default css ======-->
    <link rel="stylesheet" href="{{URL::to('/public')}}/assets/css/default.css">
...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light ">
                                <a class="navbar-brand" href="https://www.walkofweb.in"><img src="{{URL::to('/public')}}/assets/images/logo.png" alt=""></a>
                                <!-- logo -->
                                ...
                                <div class="collapse navbar-collapse sub-menu-bar main-nav__main-navigation"
                                    ...
                                    <ul class="navbar-nav ml-auto main-nav__navigation-box">
                                        <li class="nav-item active">
                                            <a class="nav-link page-scroll" href="https://www.walkofweb.in">Home</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link page-scroll" href="https://www.walkofweb.in#intro">About Us</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link page-scroll" href="https://www.walkofweb.in#features">Features</a>
                                        </li>
                                        <li class="nav-item">
                                    <a class="nav-link page-scroll" href="https://www.walkofweb.in/contactUs" target="_blank">Contact Us</a>
                                </li>
                                    </ul>
                                </div> <!-- navbar collapse -->
                            </nav>
    ...
    <section class="hero-area bg_cover" style="background-image: url({{URL::to('/public')}}assets/images/hero-bg.jpg);">
        <div class="container">
                ...
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        ...
                        <form 
                                ...
                                data-stripe-publishable-key="sk_test_51IUxQhHCUbph94h9Qm5WHrLOK314ZEopEzdPIDsnc9Au51fsc0hhoqM5CuPgAR4EIWu90WW7XInQKwQ71OflMPCF003M9k81WT"
    ...
    <section class="footer-area bg_cover" style="background-image: url({{URL::to('/public')}}assets/images/hero-bg.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-about mt-30">
                        <a href="https://www.walkofweb.in"><img src="{{URL::to('/public')}}assets/images/logo.png" alt=""></a>
    ...
    <!--====== jquery js ======-->
    <script src="{{URL::to('/public')}}assets/js/vendor/modernizr-3.6.0.min.js"></script>
    ...
    <!--====== scrolling nav js ======-->
    <script src="{{URL::to('/public')}}assets/js/jquery.easing.min.js"></script>
    <script src="{{URL::to('/public')}}assets/js/scrolling-nav.js"></script>

    <!--====== Slick js ======-->
    <script src="{{URL::to('/public')}}assets/js/slick.min.js"></script>

    <!--====== Magnific Popup js ======-->
    <script src="{{URL::to('/public')}}assets/js/jquery.magnific-popup.min.js"></script>
