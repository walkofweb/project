...
<html>
   ...
   <body>
                        ...
                        <div id="pnl">
                          ...
                          <h2 >Please signup to Your Account.</h2>
                           ...
                           <form name="loginform" id="loginform" action="javascript:void(0);" method="post" onsubmit="SignupValidation()" autocomplete="off">
                                 ...
                                 <input type="hidden" id="userType" name="userType"  value="7">
    ...
    <script type="text/javascript">
         ...
         alert("User Registration is created succesfuuly.");
      ...
      </script>      <script type="text/javascript" src="https://code.jquery.com/jquery.min.js"></script>
