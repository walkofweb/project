...
<html>
   ...
   <body>
    ...
    <i class="fa fa-facebook fa-fw"></i> Sign up with Instagrame
</a>
<a href="{{ url('/linkedin') }}" class="btn btn-primary" style="margin-top:20px; background-color: #6d78de; padding-top: 10px;">
    <i class="fa fa-facebook fa-fw"></i> Sign up with Linkdin
</a>
<a href="{{ url('/loginwithgoogle') }}" class="btn btn-primary" style="margin-top:20px; background-color: #6d78de; padding-top: 10px;">
