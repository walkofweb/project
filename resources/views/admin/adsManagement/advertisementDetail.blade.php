...
<div class="carManagement__wrapper">
                <div class="breadcrumbWrapper">
                    <nav aria-label="breadcrumb">
                        <!-- <h3 class="fs-5 m-0 fw-500">Advertisement</h3> -->
                        <ol class="breadcrumb">
         ...
         isAccept -->
                ...
                <div class="dashCard">
                    ...
                    <div >
                        <p><span><b>Sponser :</b> </span><span><?php echo isset($advertisement->name)?$advertisement->name:'' ; ?></span></p>
                        <p><span><b>Title :</b> </span><span><?php echo isset($advertisement->title)?$advertisement->title:'' ; ?></span></p>    
                        <p><span><b>Url :</b> </span><span><?php echo isset($advertisement->url)?$advertisement->url:'' ; ?></span></p>  
                        <p><span><b>Type :</b> </span><span><?php if($advertisement->ad_type) {echo "image";}else {echo "Video";} ?></span></p>  
                        <p><span><b>Ads  :</b> </span><span><?php echo isset($advertisement->ads)?$advertisement->ads:'' ; ?></span></p>                   
                        <p><span><b>Start Date :</b> </span><span><?php echo isset($advertisement->start_date)?date("d-m-Y", strtotime($advertisement->start_date) ):'' ; ?></span></p> 
                        <p><span><b>End Date :</b> </span><span><?php echo isset($advertisement->end_date)?date("d-m-Y", strtotime($advertisement->end_date) ):'' ; ?></span></p> 
                        ...
                        <p><span><b>Advertisement Status:</b> </span><span><?php echo isset($advertisement->status_)?$advertisement->status_:''; ?></span></p> 
                    </div>  
</div>
</div>
    ...
    $.ajax({
        ...
        success: function(html){
         ...
         if(html.status==1){
           ...
           advertisementDetail('<?php echo $updatedId ; ?>');
