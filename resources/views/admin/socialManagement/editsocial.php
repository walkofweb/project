                ...
                <div class="form modal-form">
                    <div class="form-group">
                        <label for="Manufacture">Title</label>
                         <input type="text" name="edit_social_title" id="edit_social_title"  class="form-control" placeholder="Title" value="<?php echo isset($socialmediaweightage->title)?$socialmediaweightage->title:'' ; ?>" readonly>
                ...
                <div class="form modal-form">
                    <div class="form-group">
                        <label for="Manufacture">WeightAge</label>
                         <input type="number" name="edit_social_weightage" id="edit_social_weightage"  class="form-control" placeholder="weightage" value="<?php echo isset($socialmediaweightage->weightage)?$socialmediaweightage->weightage:'' ; ?>">
