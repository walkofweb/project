...
<head>
    ...
    <!-- <!--====== Favicon Icon ======--  {{URL::to('/public/admin')}}/js/highcharts.js> -->
    <link rel="shortcut icon" href="{{url('public/assets/images/favicon-32x32.png')}}" type="image/png">
                        ...
                        <div id="menu" class="text-left ">
                            <ul class="offcanvas_main_menu">
                                ...
                                <li class="menu-item-has-children">
                                    <a class="page-scroll" href="{{url('/')}}">About Us</a>
                                </li>
                                <li class="menu-item-has-children ">
                                    <a class="page-scroll" href="{{url('/')}}">Features</a>
                                </li>
                               <li class="nav-item">
                                    <a class="nav-link page-scroll" href="{{url('/contactUs')}}" target="_blank">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light ">
                                <a class="navbar-brand" href="{{url('/')}}"><img src="{{url('public/assets/images/logo.png')}}" alt=""></a>
                                <!-- logo -->
                                ...
                                <div class="collapse navbar-collapse sub-menu-bar main-nav__main-navigation"
                                    ...
                                    <ul class="navbar-nav ml-auto main-nav__navigation-box">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link page-scroll" href="{{url('/user/signup')}}">Signup</a>
                                        </li>
                                        <li class="nav-item">
