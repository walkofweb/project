...
@extends('Home.layout.main')
   ...
   <!--====== HEADER PART ENDS ======-->
    ...
    <section class="hero-area bg_cover" style="background-image: url(public/assets/images/hero-bg.jpg);">
        <div class="container">
            ...
            <div class="hero-content">
                <h1 class="title"><span>Our Terms & Conditions</span></h1>
                <ul class="nav">
    ...
    <div class="container">
        <div class="cont_text">
            <h2>Welcome to Walk of Web!</h2>

            <p>These terms and conditions outline the rules and regulations for the use of Walk of Web's Website,located at https://www.walkofweb.in/.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Walk of Web if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <h2>Cookies</h2>
            <p>We employ the use of cookies. By accessing Walk of Web, you agreed to use cookies in agreement with the
                Walk of Web's Privacy Policy.</p>
            ...
            <h2>License</h2>
            <p>Unless otherwise stated, Walk of Web and/or its licensors own the intellectual property rights for all
                material on Walk of Web. All intellectual property rights are reserved. You may access this from Walk of
                Web for your own personal use subjected to restrictions set in these terms and conditions.</p>
            <p>You must not:</p>
            <ul>
                <li>Republish material from Walk of Web</li>
                <li>Sell, rent or sub-license material from Walk of Web</li>
                <li>Reproduce, duplicate or copy material from Walk of Web</li>
                <li>Redistribute content from Walk of Web</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Walk of Web does not filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect the views and opinions of Walk of Web,its agents
                and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, Walk of Web shall not be liable for the Comments
            ...
            <p>Walk of Web reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Walk of Web a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Walk of Web; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Walk of Web. Please include your name, your
            ...
            <p>No use of Walk of Web's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
            ...
            <h2>Your Privacy</h2>
            <p>Please read <a href = "https://www.walkofweb.net/privacyPolicy" >Privacy Policy</a></p>
