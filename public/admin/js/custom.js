...
function sponsor_checkout()
{
    ajaxCsrf();
    $.ajax({
    type: "get",
    url: baseUrl+'/sponsor/CkeckoutPage',
    cache: 'FALSE',
    beforeSend: function () {
    ajax_before();
    },
...
function sponsor_notification()
{
    ajaxCsrf();
    $.ajax({
    type: "post",
    url: baseUrl+'/sponser/notification',
    cache: 'FALSE',
    beforeSend: function () {
    ajax_before();
    },
...
function countryList(){
    ...
    function AddUser_packageList()
    {
        ajaxCsrf();
        $.ajax({
        type: "POST",
        url: baseUrl+'/UserpackageListing',
        cache: 'FALSE',
        beforeSend: function () {
        ajax_before();
        },
...
function postDetail(postId){
  ...
  function customerManagement(){
    ...
    function sponsor_customerManagement(){
        ajaxCsrf();
        $.ajax({
        type: "POST",
        url: baseUrl+'/sponsor/customerManagement',
        cache: 'FALSE',
        beforeSend: function () {
        ajax_before();
        },
...
function contactSupport(){
 ...
 function adsManagement(){
	...
	function sponsor_adsManagement(){

        ajaxCsrf();
        $.ajax({
        type: "POST",
        url: baseUrl+'/sponsorAdsList',
        cache: 'FALSE',
        beforeSend: function () {
        ajax_before();
        },
