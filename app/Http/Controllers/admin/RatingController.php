...
class ratingController extends Controller
{
    ...
    public function contactUs_datatable(){
        ...
        $data['title']='Walkofweb';
        $contactImg = config('constants.contact_image');
        $contactQry="select cont.id,cont.name,cont.phone_number,cont.email,cont.subject,cont.message,case when cf.image is null then '' else concat('".$contactImg."',image) end as image,fileType from contactus as cont left join contactus_files as cf on cont.id=cf.contact_id " ;
