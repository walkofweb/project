...
public function userPointStatus(Request $request)
    ...
    public function userPoint_detail(Request $request){
      ...
      'us.tiktok_video_likes_count','us.tiktok_video_shares_count','us.tiktok_video_comments_count','us.tiktok_video_view_count','us.total_point','us.avg_point','us.youtube_follower_count','us.youtube_view_count','youtube_video_count','youtube_subscriber_count')
     ...
     $user=(array)$user_point ;
      ...
      //facebook data
      $data['user_fb']=(array)DB::table('user_fb_page_info')->where('user_id',$userId)->first();

      //insta data
      $data['user_insta']=(array)DB::table('user_instagram_info')->where('userId',$userId)->first();
      //
      $data['user_youtube']=(array)DB::table('youtube_user_info')->where('userId',$userId)->first();
      //tiktok data
